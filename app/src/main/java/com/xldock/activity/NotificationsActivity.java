...
import com.xldock.R;
import com.xldock.adapter.NotificationAdapter;
import com.xldock.adapter.ResourcesAdapter;
import com.xldock.databinding.ActivityNotificationsBinding;
...
public class NotificationsActivity extends AppCompatActivity
    ...
    private ActivityNotificationsBinding mBinder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinder = DataBindingUtil.setContentView(this, R.layout.activity_notifications);
    ...
    private void initUI() {
        ...
        mBinder.rvNotifications.setLayoutManager(new LinearLayoutManager(this));
        mBinder.rvNotifications.setAdapter(mAdapter);
        getResultsFromApi();
    }
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<List<Object>>> {
        ...
        private List<List<Object>> getDataFromApi() throws IOException {
            String spreadsheetId = getString(R.string.notification_spreadsheet_id);
            String range="Notification sheet!C1:D";
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            NotificationsActivity.REQUEST_AUTHORIZATION);
                } else {
                    mBinder.tvError.setVisibility(View.VISIBLE);
